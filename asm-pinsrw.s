...
#	push		%r15
	...
	mov			%rsi, %rbp	# src buffer.  frees up rsi for more frequently-used addresses
...
.loop:
	...
	movd		0x0400(%rsi, %rbx, 4), %xmm1		# use movd over pinsrw anyway, to break the dependency chain.  (and one less uop)
	...
	pinsrw		$1, 0x0000(%rsi, %rax, 4), %xmm0
	 movzx		%cl, %eax
	pinsrw		$1, 0x0400(%rsi, %rbx, 4), %xmm1

	 movzx		%ch, %ebx
	 movd		0x0000(%rsi, %rax, 4), %xmm2		# separate dep chain for the other 8 src bytes costs 2 uops (pxor + punpck)
	 shr			$16, %rcx
	 movd		0x0400(%rsi, %rbx, 4), %xmm3		# but movd is cheaper than pinsrw.  No net uop diff.  (It is slightly faster)
...
#		movq		8(%rbp, %r11), %rcx			# next 8 source bytes
	...
	pinsrw		$4, 0x0400(%rsi, %rbx, 4), %xmm1
	...
	pinsrw		$5, 0x0400(%rsi, %rbx, 4), %xmm1
...
#		movq		16(%rbp, %r11), %rdx			# read-ahead for next iter
	...
	pinsrw		$6, 0x0400(%rsi, %rbx, 4), %xmm1
	movzx		%cl, %eax
	movzx		%ch, %ebx
	pinsrw		$7, 0x0000(%rsi, %rax, 4), %xmm0
	pinsrw		$7, 0x0400(%rsi, %rbx, 4), %xmm1
